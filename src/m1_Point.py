...
"""  # TODOE: 1. PUT YOUR NAME IN THE ABOVE LINE.
...
#
# TODOe (continued): Then implement a class called   Point that has NO METHODS
# TODOe (continued)  yet, just the lines that start the definition of any class:
#
...
def run_test_repr():
    ...
    """
    # --------------------------------------------------------------------------
    # TOeDO: 4.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_clone():
   ...
   """
    # --------------------------------------------------------------------------
    # TODeO: 5.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_to():
    ...
    """
    # --------------------------------------------------------------------------
    # eTODO: 6.  Follow the same instructions as in _TODO_ 3 above,
...
def run_test_move_by():
    ...
    You may also use this example to test this method.
        ...
        """
    # --------------------------------------------------------------------------
    # TOeDO: 7.  Follow the same instructions as in _TODO_ 3 above,
